...
chrome.tabs.onUpdated.addListener(function (tabId, changeInfo, tab) {
	...
	chrome.tabs.executeScript(
		...
		function (res) {
			if (
				chrome.runtime.lastError || // don't continue if error
				res[0]
			)
				// value of `injected` above: don't inject twice
				return;

			var cssFiles = ['assets/css/inject.css'],
				jsFiles = ['assets/lib/jquery.js', 'assets/lib/keymaster.js', 'like-on-github.js'];
